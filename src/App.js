...
let topScore = 0;
let clickAlert = "Click a character to increase your score and find out if you have what it takes to be Number 1! But beware, clicking the same character twice will result in a Game Over!";
